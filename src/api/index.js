...
app.post('/api/chat', (req, res) => {
  ...
  const prompt2 = prompt + " IF THE CANDIDATE HAS NOT GIVEN ANY CODE, PLEASE STRONGLY VALIDATE THEIR APPROACH AND SERIOUSLY ENSURE THEY GET SIGN OFF ON THE SOLUTION. IF THEY WRITE CODE BEFORE DISCUSSING APPROACHES, TRADEOFFS, ETC, PLEASE APPLY SEVERE PENALTIES WHEN GRADING THIS. PLEASE DO NOT GIVE THE CANDIDATE HINTS, AND ONLY INTERVENE TO CLARIFY THE REQUIREMENTS, CLARIFY THE SCENARIOS. EVEN IF A APPROACH IS SUGGESTED BY A CANDIDATE DO NOT GIVE THEM ANY SUBTLE HINTS AT ALL. YOU SHOULD ASK A GUIDING QUESTION WITHOUT GIVING ANYTHING AWAY. IF YOU SEE CODE GIVEN BY THE CANDIDATE, DO NOT SPIT OUT BETTER CODE. PLEASE ASK THEM TO VERIFY THE SOLUTION. IF THEY ARE COMPLETE. PLEASE ASK IF THEY ARE DONE. IF THEY SEEM TO BE CLEARLY PASSING THE QUESTION, START ASKING THEM FOLLOWUPS OR EVEN GO DEEPER INTO THE PROBLEM. ALSO IF THE CANDIDATE GIVES YOU THE CODE, PLEASE DO NOT SPIT OUT CONSIDERATIONS CORRECTIONS OR INDICATIONS OF RIGHT OR WRONG, BUT PUSH THE CANDIDATE WITHOUT GIVING ANYTHING AWAY AND TREAT THE INTERACTION LIKE A REAL INTERVIEW. PROBE DEEPER, ASK QUESTIONS TO SAVE FACE, AND ONCE YOU EXHAUST THE OPTIONS SHOULD YOU GIVE AN ANSWER AND SEVERELY DOCK POINTS FOR AVOIDING A STRUCTURED APPROACH"
